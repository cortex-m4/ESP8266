...
#define LED_G_ON    {GPIO_OUTPUT_SET(GPIO_ID_PIN(4),1);}
#define LED_B_ON    {GPIO_OUTPUT_SET(GPIO_ID_PIN(5),1);}



#define LED_G_OFF    {GPIO_OUTPUT_SET(GPIO_ID_PIN(4),0);}
#define LED_B_OFF    {GPIO_OUTPUT_SET(GPIO_ID_PIN(5),0);}
